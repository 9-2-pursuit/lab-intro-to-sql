...
INSERT INTO gifts (gift, giver, price, previously_regifted)
VALUES
('strawberry candle', 'Sandy', 11, TRUE),
('fuzzy socks', 'Mrs Santa', 20, TRUE),
('glass mugs', 'Grinch', 1, FALSE ),
('missle toe', 'Karyn', 18, FALSE),
('candy cane', 'Amy', 12, TRUE);
...
SELECT gift FROM gifts WHERE giver ILIKE '%santa%' OR price > 30;
--
