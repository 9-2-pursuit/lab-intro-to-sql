...
INSERT INTO gifts (gift, giver, price) VALUES ('peach candle', 'Santa', 9);
...
INSERT INTO gifts (gift, giver, price, previously_regifted)
VALUES 
('vanilla candle', 'Dolf', 6, TRUE),
('mario kart N. Switch', 'Rocky', 40, FALSE),
('cologne', 'Adrian', 35, FALSE),
('sneakers', 'Apollo', 45, FALSE),
('Beer', 'Paulie', 12, TRUE)
;
...
SELECT * FROM gifts WHERE giver ILIKE 'Santa';
