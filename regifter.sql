...
CREATE TABLE gifts ( id serial primary KEY, gift varchar(30), giver varchar(30), value INT, previously_regifted BOOLEAN );
...
INSERT into gifts (gift, giver, price, previously_regifted)
VALUES
('sakura candle', 'Santa', 9, TRUE),
('Sonic 2006', 'someone', '-20', TRUE),
('ACTION 52', 'AVGN', '100', FALSE),
('real doll', 'weeb', '1000', TRUE),
('face eating leopards', 'cat person', '100', FALSE);
