...
CREATE TABLE 
gifts
(id SERIAL, gift TEXT NOT NULL, giver TEXT NOT NULL, value INT, previously_regifted BOOLEAN );
...
VALUES
('lightsaber', 'Darth Maul', 27, FALSE),
('yoru', 'Dracule Mihawk', 599, TRUE),
('allspark','Optimus Prime', 1999, FALSE),
('murakumogiri','White Beard', 999, TRUE),
('blood candle', 'Dracula',4, FALSE)
;
...
--
\echo Delete all the gifts from Santa and return the 'value' and 'gift' of the gifts you have deleted
--
...
--
SELECT * FROM gifts LIMIT 3 OFFSET 1 ORDER BY price DESC;
