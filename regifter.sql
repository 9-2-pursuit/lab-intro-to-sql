...
INSERT INTO gifts (gift, giver, price, previously_regifted)
VALUES
('apple candle', 'Bob', '33', TRUE),
('pineapple candle', 'Jack', '6', TRUE),
('book', 'winnie the pooh', '129', FALSE),
('honey', 'Tigger', '2222', TRUE),
('pear candle', 'John', '46', FALSE)
;
