...
-- 
INSERT INTO gifts (gift, giver, value, previously_regifted) VALUES ('Soccer cleats', 'Godwin', 230, TRUE), ('Juicer', 'Arielle', 45, TRUE), ('Croc Rainboots', 'Madisyn', 42, false), ('Flower pot', 'Michael', 120, TRUE), ('Peony Cherry Blossom  candle', 'Atina', 10, false);

-- I had added 5 gifts of my own choosing prior to seeing this list.
...
--
INSERT INTO gifts (gift, giver, value, previously_regifted) VALUES ('Headphones', 'Kunle', 150, false), ('Movie ticket', 'Aubrey', 20, TRUE), ('Knives', 'Amy', 75, false), ('Wine glasses', 'Ria', 50, false), ('Red wine', 'Angela', 14, false);
